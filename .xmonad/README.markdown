# xmonad-config
xmonad-config is the [xmonad](http://xmonad.org/) configuration used by Justin Mazzi. 
Originally forked from Vic Fryzel's config.
...
![Screenshot of xmonad-config](/jmazzi/dotfiles/blob/master/.xmonad/screenshot.png)
...
you may already have, cloning the git repository, and updating your PATH.
    ...
    git clone https://github.com/jmazzi/xmonad-config.git .xmonad
